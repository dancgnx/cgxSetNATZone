...
def go():
    ...
    custom_group = parser.add_argument_group('custom_args', 'Set')
    custom_group.add_argument("--elements",  help="A text file with one Element/ION name per line",required=False, default=None, action="store", type=argparse.FileType('r'))
    custom_group.add_argument("--element",  help="Element/ION. Can repeat for multiple elements/IONs",required=False, default=[], action="append")
    custom_group.add_argument("--interface",  help="Interface to apply zone to. Can repeat for multiple interfaces",required=True, default=[], action="append")
    custom_group.add_argument("--zone",  help="NAT Zone name",required=True)
    custom_group.add_argument("--list_elements",  default=False, action="store_true",help="List all elements")
